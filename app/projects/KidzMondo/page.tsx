...
export default function KidzMondoPage() {
  ...
  return (
    <div className="kidz-page">
      ...
      {/* OVERVIEW (same container width as all sections) */}
          ...
          <div className="kidz-overview__grid">
            ...
            <div className="kidz-overview__content">
              ...
              <p className="kidz-overview__p">
                KidzMondo is a replica of a real-life city which provides children between the ages
                of 2 to 14 with role play activities that are designed to be fun and pedagogical,
                based on the ‘edutainment’ or playful learning concept.
              </p>
              <p className="kidz-overview__p">
      ...
      {/* MAIN CONTENT (same container width) */}
                ...
                <div className="list-desc kidz-sections">
                  <div className="desc-blog">
                    ...
                    <p className="body-2">
                      ...
                      attitudes while also motivating creative thinking and enhancing self-esteem
                      and self-confidence levels.
                      <br />
                      <br />
                      KidzMondo also teaches financial literacy by establishing its own economy,
                      where kids exchange Kidlars, the local city currency, learning about money and
                      how to utilize it.
                    </p>
                  </div>

                  <div className="desc-blog">
                    <h5 className="title-desc kidz-sections__mt">Entertainment</h5>
                    <p className="body-2">
                      Children can choose between 120+ different professions which are practiced in
                      a replica of the most representative establishments in an actual city; an
                      airport, a bank, factories, a theater, shops, a police station, a fire
                      department, a newspaper publisher, a hotel, a TV studio, a radio station, a
                      gas station, a racetrack and many more…
                    </p>
                  </div>

                  <div className="desc-blog">
                    <h5 className="title-desc kidz-sections__mt">Edutainment Competencies</h5>
                    <p className="body-2">The KidzMondo experience develops a wide range of competencies:</p>
                    <ul className="body-2">
